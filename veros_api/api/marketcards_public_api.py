...
class MarketcardsPublicApi(object):
    ...
    def marketcards_public_go(self, id, data, **kwargs):  # noqa: E501
        """marketcards_public_go  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.marketcards_public_go(id, data, async_req=True)
        >>> result = thread.get()
        ...
        return self.marketcards_public_go_with_http_info(id, data, **kwargs)  # noqa: E501

    def marketcards_public_go_with_http_info(self, id, data, **kwargs):  # noqa: E501
        """marketcards_public_go  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.marketcards_public_go_with_http_info(id, data, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method marketcards_public_go" % key
                )
        ...
        if ('id' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `marketcards_public_go`")  # noqa: E501
        # verify the required parameter 'data' is set
        if ('data' not in local_var_params or
                local_var_params['data'] is None):
            raise ApiValueError("Missing the required parameter `data` when calling `marketcards_public_go`")  # noqa: E501
    ...
    def marketcards_public_list(self, **kwargs):  # noqa: E501
        """marketcards_public_list  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.marketcards_public_list(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.marketcards_public_list_with_http_info(**kwargs)  # noqa: E501

    def marketcards_public_list_with_http_info(self, **kwargs):  # noqa: E501
        """marketcards_public_list  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.marketcards_public_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method marketcards_public_list" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
    ...
    def marketcards_public_read(self, id, **kwargs):  # noqa: E501
        """marketcards_public_read  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.marketcards_public_read(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.marketcards_public_read_with_http_info(id, **kwargs)  # noqa: E501

    def marketcards_public_read_with_http_info(self, id, **kwargs):  # noqa: E501
        """marketcards_public_read  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.marketcards_public_read_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method marketcards_public_read" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in local_var_params or
                local_var_params['id'] is None):
            raise ApiValueError("Missing the required parameter `id` when calling `marketcards_public_read`")  # noqa: E501
